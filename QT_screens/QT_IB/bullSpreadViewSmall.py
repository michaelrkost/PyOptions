...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_Contracts.setTabText(self.tabWidget_Contracts.indexOf(self.getStuff_tab), _translate("MainWindow", "Option Contracts "))
        self.tabWidget_Contracts.setTabText(self.tabWidget_Contracts.indexOf(self.greek_tab), _translate("MainWindow", "The Greeks"))
        self.tabWidget_Contracts.setTabText(self.tabWidget_Contracts.indexOf(self.bullSpread_tab), _translate("MainWindow", "Bear Spreads"))
