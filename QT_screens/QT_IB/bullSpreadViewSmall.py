...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon.addPixmap(QtGui.QPixmap(":/resources/icons/ConnectEstablished.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_Contracts.setTabText(self.tabWidget_Contracts.indexOf(self.Contract_tab), _translate("MainWindow", "Option Contracts "))
        self.tabWidget_Contracts.setTabText(self.tabWidget_Contracts.indexOf(self.tab_2), _translate("MainWindow", "Bear Spreads"))
