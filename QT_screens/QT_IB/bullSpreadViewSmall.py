...
class Ui_MainPyOptionsWindow(object):
    def setupUi(self, MainPyOptionsWindow):
        ...
        self.widget = QtWidgets.QWidget(self.bullSpread_tab)
        self.widget.setGeometry(QtCore.QRect(171, 10, 260, 28))
        ...
        self.spinBox_numberOfContracts = QtWidgets.QSpinBox(self.widget)
        ...
        self.pushButton_updateNumberOfContracts = QtWidgets.QPushButton(self.widget)
