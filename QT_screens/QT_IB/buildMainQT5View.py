...
class Ui_MainPyOptionsWindow(object):
    def setupUi(self, MainPyOptionsWindow):
        ...
        self.label_9.setGeometry(QtCore.QRect(640, 70, 321, 20))
...
"color: rgb(32, 74, 135);")
        ...
        MainPyOptionsWindow.setTabOrder(self.qualifyContracts, self.radioButton_Put)
        MainPyOptionsWindow.setTabOrder(self.radioButton_Put, self.radioButton_Index)
        ...
        MainPyOptionsWindow.setTabOrder(self.radioButton_Option, self.radioButton_Call)
        MainPyOptionsWindow.setTabOrder(self.radioButton_Call, self.radioButton_MktDataType_Live)
